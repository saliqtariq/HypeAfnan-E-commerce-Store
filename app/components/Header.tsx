    ...
    <header className="header">
      <nav className="header__nav">
        ...
        <div className="header__left">
          <button className="header__btn" type="button" id="category-btn">
            <svg
              width="18"
              height="14"
              viewBox="0 0 18 14"
            ...
            <span className="header__btn-text">Category</span>
          </button>

          <button className="header__btn" type="button" id="search-btn">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
        ...
        <Link href="/" className="header__brand" id="brand-link">
          <div className="header__logo-wrapper">
            <Image
              src="/hypeafnanlogo.png"
              alt="HypeAfnan Logo"
              width={36}
              height={36}
          ...
          <span className="header__brand-name">HypeAfnan</span>
        </Link>

        {/* Right Section */}
        <div className="header__right">
          <button className="header__icon-btn" type="button" id="language-btn" aria-label="Language">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
